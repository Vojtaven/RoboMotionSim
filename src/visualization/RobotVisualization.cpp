...
//}
//
//CompositeShape Visualization::GenerateGridLines(const sf::Vector2f size, const sf::Vector2f spacing, const sf::Vector2f origin, const sf::Color color, const float thickness) {
//	CompositeShape grid;
