...
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE_WITH_DEFAULT(RenderSettings, lockViewOnRobot, frameRateLimit, scaleFactor, gridSpacing, gridColor, lockGridSpacingRatio, showGrid)
